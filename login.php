...
if( isset($_POST['submit']) ){
		...
		if( $row === 1){
			...
			if( $cek_pass <> $password) {
				...
				$_SESSION['log'] = true; 
				echo"<script>
					alert ('LOGIN BERHASIL'); document.location.href = 'Dashboard/carilapak.php'
				</script>";
				
			}
		}else {
			echo"<script>
					alert ('Username Salah atau belum terdafar BOS');
				</script>";
		}
}
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Selamat Datang di Sistem Pasar Tradisonal
